...
<div class="comments-section">
  ...
  <div class="comments-wrap wrap cf">

    <?php if ( have_comments() ) : ?>

      <h3 id="comments-title" class="h2 section-title"><?php comments_number( __( '<span>No</span> Comments', 'bonestheme' ), __( '<span>One</span> Comment', 'bonestheme' ), __( '<span>%</span> Comments', 'bonestheme' ) );?></h3>
